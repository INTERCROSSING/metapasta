...
//class ParseInstructions(aws: AWS) extends MapInstructions[List[MergedSampleChunk], List[ParsedSampleChunk]] {
//
//  val logger = Logger(this.getClass)
//
//  def apply(input: List[MergedSampleChunk]): List[ParsedSampleChunk] = {
