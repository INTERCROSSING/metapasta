...
//import ohnosequences.compota.logging.S3Logger
//import ohnosequences.metapasta._
//import ohnosequences.metapasta.databases.{Installable, BlastDatabase16S}
...
//                       database: Installable[BlastDatabase16S],
//                       blastCommandTemplate: String,
//                       useXML: Boolean,
//                       logging: Boolean,
...
//
//
//  case class BlastContext(database: BlastDatabase16S, blast: Blast, assigner: Assigner)
//
//  override type Context = BlastContext
//
//  val logger = new ConsoleLogger("BLAST instructions")
//
//  //todo think about this space
//  def extractHeader(s: String) = s.replace("@", "").split("\\s")(0)
//
//
//  override def prepare(workingDirectory: File): Try[Context] = {
//    val lm = aws.s3.createLoadingManager()
//    val blastDatabase = database.get(logger, workingDirectory, lm)
